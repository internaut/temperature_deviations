...
Which years feature the most deviation now with this model? As we can see, the three hottest years all occurred recently:
...
When we sort by proportion of unusually warm day temperatures, we see the expected picture of a top five list consisting purely of recent years:
